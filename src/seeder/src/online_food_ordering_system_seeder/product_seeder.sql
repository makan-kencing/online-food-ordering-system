...
('R1PIZ001', 'Margherita Pizza', 'Classic Italian pizza with fresh basil', DATE '2024-01-15', '/images/r1/margherita.jpg', 1),
...
('R2BRG001', 'Classic Cheeseburger', 'Beef patty with melted cheese', DATE '2024-02-10', '/images/r2/cheeseburger.jpg', 2),
...
('R7PIZ001', 'Gluten Free Margherita', 'GF crust with fresh basil', DATE '2024-07-10', '/images/r7/gf-margherita.jpg', 7),
...
('R9PIZ002', 'Four Cheese Pizza', 'Mozzarella, cheddar, parmesan, blue', DATE '2024-09-15', '/images/r9/four-cheese.jpg', 9),
('R9PIZ003', 'Mushroom Truffle Pizza', 'Wild mushrooms with truffle oil', DATE '2024-10-01', '/images/r9/truffle.jpg', 9),
...
BEGIN
    ...
    FOR i IN 1..3 LOOP
            ...
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Size_' || v_product_code, 1, 1, 1);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Crust_' || v_product_code, 1, 1, 1);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Spice_' || v_product_code, 1, 1, 1);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Toppings_' || v_product_code, 0, 5, 1);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Remove_' || v_product_code, 0, 3, 1);
        END LOOP;

    -- Restaurant 2 (3 products × 4 groups = 12)
    FOR i IN 1..3 LOOP
            v_product_code := 'R2BRG00' || i;
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Size_' || v_product_code, 1, 1, 2);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Patty_' || v_product_code, 1, 1, 2);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Doneness_' || v_product_code, 1, 1, 2);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Toppings_' || v_product_code, 0, 4, 2);
        END LOOP;

    -- Restaurant 3 (3 products × 3 groups = 9)
    FOR i IN 1..3 LOOP
            v_product_code := 'R3BEV00' || i;
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Size_' || v_product_code, 1, 1, 3);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Ice_' || v_product_code, 1, 1, 3);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Sugar_' || v_product_code, 1, 1, 3);
        END LOOP;

    -- Restaurant 4 (3 products × 3 groups = 9)
    FOR i IN 1..3 LOOP
            v_product_code := 'R4SIDE0' || i;
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Size_' || v_product_code, 1, 1, 4);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Cook_' || v_product_code, 1, 1, 4);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Dip_' || v_product_code, 0, 2, 4);
        END LOOP;

    -- Restaurant 5 (3 products × 4 groups = 12)
    FOR i IN 1..3 LOOP
            v_product_code := 'R5PIZ00' || i;
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Size_' || v_product_code, 1, 1, 5);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Crust_' || v_product_code, 1, 1, 5);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Spice_' || v_product_code, 1, 1, 5);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Toppings_' || v_product_code, 0, 5, 5);
        END LOOP;

    -- Restaurant 6 (3 products × 3 groups = 9)
    FOR i IN 1..3 LOOP
            v_product_code := 'R6DES00' || i;
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Size_' || v_product_code, 1, 1, 6);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Flavor_' || v_product_code, 1, 1, 6);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Toppings_' || v_product_code, 0, 3, 6);
        END LOOP;

    -- Restaurant 7 (3 products × 3 groups = 9)
    FOR i IN 1..3 LOOP
            v_product_code := 'R7PIZ00' || i;
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Size_' || v_product_code, 1, 1, 7);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Crust_' || v_product_code, 1, 1, 7);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Spice_' || v_product_code, 1, 1, 7);
        END LOOP;

    -- Restaurant 8 (3 products × 3 groups = 9)
    FOR i IN 1..3 LOOP
            v_product_code := 'R8COF00' || i;
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Size_' || v_product_code, 1, 1, 8);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Type_' || v_product_code, 1, 1, 8);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Milk_' || v_product_code, 0, 1, 8);
        END LOOP;

    -- Restaurant 9 (3 products × 3 groups = 9)
    FOR i IN 1..3 LOOP
            v_product_code := 'R9PIZ00' || i;
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Size_' || v_product_code, 1, 1, 9);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Crust_' || v_product_code, 1, 1, 9);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Spice_' || v_product_code, 1, 1, 9);
        END LOOP;

    -- Restaurant 10 (3 products × 3 groups = 9)
    FOR i IN 1..3 LOOP
            v_product_code := 'R10TEA0' || i;
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Size_' || v_product_code, 1, 1, 10);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Ice_' || v_product_code, 1, 1, 10);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Sweetener_' || v_product_code, 0, 1, 10);
        END LOOP;

    -- Restaurant 11 (3 products × 3 groups = 9)
    FOR i IN 1..3 LOOP
            v_product_code := 'R11NOD0' || i;
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Size_' || v_product_code, 1, 1, 11);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Noodle_' || v_product_code, 1, 1, 11);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Spice_' || v_product_code, 1, 1, 11);
        END LOOP;

    -- Restaurant 12 (3 products × 3 groups = 9)
    FOR i IN 1..3 LOOP
            v_product_code := 'R12SUS0' || i;
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Size_' || v_product_code, 1, 1, 12);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Type_' || v_product_code, 1, 1, 12);
            INSERT INTO product_feature_group (name, min, max, created_by_id) VALUES ('Dip_' || v_product_code, 0, 2, 12);
        END LOOP;
END;
/
...
BEGIN
    ...
    FOR rec IN (SELECT id, name, created_by_id FROM product_feature_group ORDER BY id) LOOP
            ...
            IF rec.name LIKE 'Size_%' THEN
                FOR feat IN (SELECT id FROM product_feature
                             WHERE name IN ('Small', 'Medium', 'Large', 'Regular', 'Personal', 'Family', 'Extra Large')
                               AND created_by_id = v_created_by) LOOP
                        BEGIN
            ...
            IF rec.name LIKE 'Toppings_%' THEN
                FOR feat IN (SELECT id FROM product_feature
                             WHERE name LIKE 'Extra%' AND created_by_id = v_created_by) LOOP
                        BEGIN
                            INSERT INTO product_feature_group_field (product_feature_group_id, product_feature_id)
                            VALUES (rec.id, feat.id);
                            v_counter := v_counter + 1;
            ...
            IF rec.name LIKE 'Patty_%' THEN
                FOR feat IN (SELECT id FROM product_feature
                             WHERE name LIKE '%Patty' AND created_by_id = v_created_by) LOOP
                        BEGIN
                            INSERT INTO product_feature_group_field (product_feature_group_id, product_feature_id)
                            VALUES (rec.id, feat.id);
                            v_counter := v_counter + 1;
            ...
            IF rec.name LIKE 'Doneness_%' OR rec.name LIKE 'Cook_%' THEN
                FOR feat IN (SELECT id FROM product_feature
                             WHERE name IN ('Well Done', 'Regular Cook', 'Light Cook') AND created_by_id = v_created_by) LOOP
                        BEGIN
                            INSERT INTO product_feature_group_field (product_feature_group_id, product_feature_id)
                            VALUES (rec.id, feat.id);
                            v_counter := v_counter + 1;
...
BEGIN
    ...
    FOR prod IN (SELECT id, code, created_by_id FROM product) LOOP
            v_product_code := prod.code;
            v_created_by := prod.created_by_id;

            FOR grp IN (SELECT id FROM product_feature_group
...
BEGIN
    ...
    FOR prod IN (SELECT id, created_by_id FROM product) LOOP
            v_created_by := prod.created_by_id;
...
BEGIN
    ...
    FOR rest IN (SELECT id, created_by_id FROM restaurant) LOOP
            BEGIN
                SELECT id INTO v_group_id FROM menu_item_group WHERE name = (
            ...
            FOR prod IN (SELECT id FROM product WHERE created_by_id = rest.created_by_id) LOOP
                    BEGIN
...
SELECT 'RESTAURANT' AS table_name, COUNT(*) AS record_count FROM RESTAURANT UNION ALL
SELECT 'MENU_ITEM_GROUP', COUNT(*) FROM MENU_ITEM_GROUP UNION ALL
SELECT 'PRODUCT', COUNT(*) FROM PRODUCT UNION ALL
SELECT 'PRODUCT_CATEGORY', COUNT(*) FROM PRODUCT_CATEGORY UNION ALL
SELECT 'PRODUCT_FEATURE', COUNT(*) FROM PRODUCT_FEATURE UNION ALL
SELECT 'PRODUCT_FEATURE_GROUP', COUNT(*) FROM PRODUCT_FEATURE_GROUP UNION ALL
SELECT 'PRODUCT_FEATURE_GROUP_FIELD', COUNT(*) FROM PRODUCT_FEATURE_GROUP_FIELD UNION ALL
SELECT 'PRODUCT_ATTRIBUTE', COUNT(*) FROM PRODUCT_ATTRIBUTE UNION ALL
SELECT 'PRODUCT_CATEGORY_CLASSIFICATION', COUNT(*) FROM PRODUCT_CATEGORY_CLASSIFICATION UNION ALL
